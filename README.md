...
| Event | Host | Result | Domain |
|-------|------|--------|--------|
| 🥇 IBM ICE Day 2026 | IILM University | **1st Prize** | Cybersecurity AI |
| 🥉 IBM ICE Day 2025 | IILM University | **3rd Prize** | AR/VR |
| ⚔️ Hack IITK | IIT Kanpur | **Semi-Finalist** | Cybersecurity |
...
## 📊 Kaggle · Open Data Contributions

> *Publishing datasets that the community actually uses — worldwide.*

| Dataset | Upvotes | Impact |
|---------|---------|--------|
| 🎥 TMDB Top Rated Movies | **26 upvotes · #3 Trending** | Worldwide contributors · went viral in community |
| 📱 Smartphone Dataset | **20 upvotes** | Submitted to active competition |
| 🏅 Competition Rank | **1371 / 4317** | Top 32% globally |

[![Kaggle](https://img.shields.io/badge/Kaggle-20BEFF?style=for-the-badge&logo=kaggle&logoColor=white)](https://www.kaggle.com/utkarshsahil04)
...
| Category | Algorithms |
|----------|-----------|
| **Regression** | Linear, Ridge, Lasso, Polynomial, Logistic |
| **Tree-Based** | Decision Trees, Random Forest, Gradient Boosting, XGBoost |
| **Instance-Based** | KNN, Naive Bayes |
| **SVM** | Linear SVM, Kernel Trick, SVR |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/utkarsh-verma-566a4630b/)
[![Kaggle](https://img.shields.io/badge/Kaggle-20BEFF?style=for-the-badge&logo=kaggle&logoColor=white)](https://www.kaggle.com/utkarshsahil04)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/utkarshsahil04)
